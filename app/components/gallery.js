        ...
        <div className="border-l-4 border-[#a4c875] pl-4 sm:pl-6 space-y-2">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 pt-4">
            <div className="px-3 py-1 bg-[#141a0e] border border-[#a4c875]/30 font-mono-tech text-[9px] sm:text-[10px] text-[#a4c875] uppercase tracking-widest inline-block text-center sm:text-left">
              LIVE FEED: ({currentDisplayIndex}/{totalOriginalImages})
            </div>
            <div className="px-3 py-1 bg-[#141a0e] border border-[#a4c875]/30 font-mono-tech text-[9px] sm:text-[10px] text-[#a4c875] uppercase tracking-widest inline-block text-center sm:text-left">
              ARCHIVE: SECURE
            </div>
          ...
          >
            ...
            {images.map((img, index) => {
              ...
              return (
                <div
                  key={`${img.id}-${index}`}
                  className={`tactical-card-container group relative flex-shrink-0 w-[85%] md:w-[45%] lg:w-[31%] overflow-hidden border-4 bg-[#14190f] cursor-crosshair transition-all duration-500 ${isCurrentActive
